SUMMARY = "WendyOS generic x86_64 kernel module coverage"
DESCRIPTION = "Network, Bluetooth, GPU, and USB4/Thunderbolt kernel modules for \
commodity x86 mini PCs and NUC-class systems"
LICENSE = "MIT"
...
# Pulled into the image by conf/distro/include/x86-image.inc. Commodity x86
# mini PCs and NUC-class systems vary widely in network hardware, so keep these
# as recommendations: the image still builds if a kernel provider does not emit
# one of the optional module packages.
RRECOMMENDS:${PN} = " \
