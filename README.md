...
- `WENDYOS_CAN` - Enable SocketCAN support: CAN kernel drivers and module packages (default: 1 on Tegra/RPi/x86, 0 everywhere else)
- `WENDYOS_PERSIST_JOURNAL_LOGS` - Persist logs to storage (default: tracks `WENDYOS_OTA` — 0 when it is "none", 1 otherwise)
